...
## Ecosystem position
 Private and local AI runtime stack

## Current mission
Private AI layer: provides a local model registry/runtime abstraction designed for controlled, privacy-preserving AI workloads.
